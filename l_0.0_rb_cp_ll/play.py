...
reward_process = CostPlusReward(value, reward_win, reward_lose, 
...
agents = [A2CAgent(2, [400, 400, 300, 100], 22,
                    learning_rate = 5.0e-6, gamma = 1.0) for _ in range(n_agents)]

principal = A2CAgent(2, [10, 10], 21, learning_rate = 5e-4, gamma = 1.0)

winner = [A2CAgent(3, [400, 400, 200, 100], 20, learning_rate = 3.0e-5, gamma = 1.0) for _ in range(n_types)]
