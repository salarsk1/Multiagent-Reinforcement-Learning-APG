...
agents = [A2CAgent(2, [300, 300, 300, 200], 22,
                    learning_rate = 8.0e-6, gamma = 1.0) for _ in range(n_agents)]

principal = A2CAgent(2, [10, 10], 21, learning_rate = 5e-4, gamma = 1.0)

winner = [A2CAgent(3, [400, 400, 200, 100], 20, learning_rate = 8.0e-5, gamma = 1.0) for _ in range(n_types)]
...
if __name__ == "__main__":
    ...
    run(env, n_episodes, steps_per_episode, n_agents, cost_funcs, type_dict,
        ...
        max_bid = 5.0, write_output_every=30_000, 
