...
value = RPIValueFunction(market_min, market_worth, 1.0, q_min)
...
reward_process = IncentiveCostPlusReward(value, reward_win, reward_lose, 
...
agents = [A2CAgent(2, [300, 300, 300, 200], 22,
                    learning_rate = 4.0e-6, gamma = 1.0) for _ in range(n_agents)]

principal = A2CAgent(2, [10, 10], 21, learning_rate = 5e-4, gamma = 1.0)

winner = [A2CAgent(3, [500, 500, 200], 20, learning_rate = 5.0e-5, gamma = 1.0) for _ in range(n_types)]
